...
def k_contrast_color(k_color, RGB_list):
  # hue       : 0-360, min_step: 5(72)
  # saturation: 0.3-0.8, min_step: 0.1(6)
  # intensive : 0.5-1.0, min_step: 0.1(6)
  # max_color = 72*6*6 = 2592

  H_min_step = 5
  H_max_num = 360 // H_min_step
  S_min_step = 0.1
  S_max_num = 0.5 // S_min_step + 1
  I_min_step = 0.1
  I_max_num = 0.5 // I_min_step + 1
...
if __name__ == '__main__':
  ...
  colors = []
  k_contrast_color(grid_len*grid_wid, colors)
  print()
  # print('color len:', len(colors), colors)
  map_back.fill((0,0,0))
  while 1:
