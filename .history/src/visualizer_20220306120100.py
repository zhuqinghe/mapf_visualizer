...
parser.add_argument('--map', default='../random', type=str, help='map file path')
parser.add_argument('--paths', default='../paths.txt', type=str, help='path results')
parser.add_argument('--save', default=False, type=bool, help='save displaying or not')
parser.add_argument('--save_mode', default='video', type=str, help='save mode[video/gif]')


class Visualizer(object):
  def __init__(self, map_file, paths_file, grid_size=30, fps=25, show_start=1, save_video=1):
    ...
    for i in range(self.agent_num):
      self.Agents.append(Agent(i, 
                              self.colors[i], 
                              self.Paths.patfont_yaheiboldhs[i]))
...
if __name__ == '__main__':
  vis = Visualizer('random-32-32-20.map', 'paths.txt', show_start=0, save_video=0)
  vis.display()